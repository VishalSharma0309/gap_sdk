...

{
	...
	Ker Arg: In, Tiled Space: Tile0
		...
		T0: [Tile0 Dyn: 0], T1: [Tile0 Dyn: 1], T2: [Tile0 Dyn: 2]
...

{
	...
	Ker Arg: KerIn, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[64x48], 1]
		Tile0: [0, 3072, 3072], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
	...
	Ker Arg: KerOut, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[64x48], 4]
		Tile0: [0, 12288, 12288], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*=========================== Call Kernel, Invariant assignment =====================*/
...

{
	...
	Ker Arg: KerIn, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[51x38], 1]
		Tile0: [0, 1938, 1938], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	Ker Arg: KerBuffer, Tiled Space: Buffer
		Min Pipe Depth: 0, Max Pipe Depth: 0
		KerArgItSpace: 1 logical tiles, 1 physical tiles
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[51x1], 4]
		Tile0: [0, 204, 204], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	Ker Arg: KerOut, Tiled Space: Buffer
		Min Pipe Depth: 0, Max Pipe Depth: 0
		KerArgItSpace: 1 logical tiles, 1 physical tiles
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[51x38], 4]
		Tile0: [0, 7752, 7752], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*=========================== Call Kernel, Invariant assignment =====================*/
...

{
	...
	Ker Arg: KerOut, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[28x15], 4]
		Tile0: [0, 1680, 1680], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*================================= Read Tiles Prolog ===============================*/
...

{
	...
	Ker Arg: KerBuffer, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[40x1], 4]
		Tile0: [0, 160, 160], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	Ker Arg: KerOut, Tiled Space: Buffer
		Min Pipe Depth: 0, Max Pipe Depth: 0
		KerArgItSpace: 1 logical tiles, 1 physical tiles
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[40x30], 4]
		Tile0: [0, 4800, 4800], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*=========================== Call Kernel, Invariant assignment =====================*/
...

{
	...
	Ker Arg: KerOut, Tiled Space: Buffer
		...
		KerArgItSpace (User Kernel Iter Order):
			[Tile0, 1:[17x7], 4]
		Tile0: [0, 476, 476], Tile1: [0, 0, 0], Tile2; [0, 0, 0]
		T0: [Tile0: 0], T1: [Tile0: 0], T2: [Tile0: 0]
	======================== End Ker Arg Iter Spaces =========================================*/
	/*================================= Read Tiles Prolog ===============================*/
